...
var HELP_REPROMPT = "Ask me something in the format of: When is the next train from 'first stop' to 'last stop'?";
...
var handlers = {
    ...
    'GetNextTrainIntent': function () {
        var first = this.event.request.intent.slots.first_stop.value;
        var last = this.event.request.intent.slots.last_stop.value;
...
//        this.emit(':tellWithCard', speechOutput, SKILL_NAME, times);
        ...
        var speechOutput = "The first stop is " + first + ". The last stop is " + last + ".";
